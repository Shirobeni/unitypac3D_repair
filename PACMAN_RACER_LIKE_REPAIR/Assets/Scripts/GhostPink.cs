...
public class GhostPink : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (tracking)
        {
            ...
            {
                ijikeTime = 0f;
                transform.GetChild(0).gameObject.GetComponent<Renderer>().material.color = new Color(200f, 0f, 50f);
                //rigidbody.velocity = m_navMeshAgent.desiredVelocity;
            }
            else if (ijike == true)
            {
        ...
        else if (ijike == true)
        {
            ...
            else if (ijikeTime > 7.0f)
            {
                ...
                transform.GetChild(0).GetComponent<Renderer>().material.color = new Color(200f, 0f, 50f);
            }
        }
    ...
    void OnDrawGizmos()
    {
        ...
        {
            Gizmos.color = new Color(200f, 0f, 50f);
    ...
    IEnumerator mahi()
    {
        ...
        transform.GetChild(0).gameObject.GetComponent<Renderer>().material.color = new Color(200f, 1f, 50f);
        yield return new WaitForSeconds(0.1f);
    }
    IEnumerator Eaten()
    {
